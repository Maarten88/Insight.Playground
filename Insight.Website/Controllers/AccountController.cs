...
namespace Insight.Website.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        private ContactUserManager _userManager;

        public AccountController()
        {
        }

        public AccountController(ContactUserManager userManager)
        {
            UserManager = userManager;
        }

        public ContactUserManager UserManager {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<ContactUserManager>();
            }
            private set
            {
                _userManager = value;
